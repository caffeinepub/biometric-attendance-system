...
export class Backend implements backendInterface {
    ...
    async enrollFace(arg0: FaceData): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAllFaces(): Promise<Array<FaceData>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllFaces();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAttendanceRecord(arg0: string): Promise<AttendanceRecord> {
        if (this.processError) {
            try {
    ...
    async getFace(arg0: string): Promise<FaceData> {
        if (this.processError) {
            try {
                const result = await this.actor.getFace(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTodaysStats(arg0: string): Promise<{
        totalStudents: bigint;
        presentCount: bigint;
        absentCount: bigint;
    }> {
        if (this.processError) {
            try {
                const result = await this.actor.getTodaysStats(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUnmarkedStudents(arg0: string): Promise<Array<Student>> {
        if (this.processError) {
            try {
                const result = await this.actor.getUnmarkedStudents(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
